...
class CreateQuotedArticleRequest extends AbstractRequest
{
    ...
    public function assertPayload(): void
    {
        ...
        Assert::lazy()->tryAll()
            ...
            ->that($payload[self::PARAM_NAME], self::PARAM_NAME)->notNull()->string()->notEmpty()
            ->that($payload[self::PARAM_VOLUME], self::PARAM_VOLUME)->notNull()->float()->greaterOrEqualThan(0)
